...
- [ ] 1.1 Schedule `reclaimGroups({ prune: true })` once, 60 seconds after start,
      under `guarded()`
- [ ] 1.2 Version bump (header, constant, README literal)

## 2. Verification

- [ ] 2.1 `scripts/verify.ps1` passes (anchor the new requirement)
